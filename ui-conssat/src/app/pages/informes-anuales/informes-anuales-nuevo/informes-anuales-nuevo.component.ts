...
export class InformesAnualesNuevoComponent implements OnInit {
  ...
  constructor(public comisiones: MatDialog, public nroSesiones: MatDialog, private fb: FormBuilder, private spinnerService: NgxSpinnerService, private router: Router, private location: Location,
