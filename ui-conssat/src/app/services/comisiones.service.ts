...
export class ComisionesService {
  ...
  public actualizarComision(req: FormData): Observable<ComisionesResponse> {
    ...
    return this.http.put<ComisionesResponse>(`${backendUrl}api/comisiones/actualizar`, req, httpOptions);
  }
  ...
  public actualizarIntegrantesComision(req: FormData): Observable<ComisionConsejoResponse> {
    ...
    return this.http.put<ComisionConsejoResponse>(`${backendUrl}api/comisiconsej/actualizar`, req, httpOptions);
  }
