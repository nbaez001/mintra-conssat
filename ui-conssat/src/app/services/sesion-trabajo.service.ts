...
export class SesionTrabajoService {
  ...
  public actualizarSesionTrabajo(req: FormData): Observable<SesionTrabajoResponse> {
    ...
    return this.http.put<SesionTrabajoResponse>(`${backendUrl}api/sesion/actualizar`, req, httpOptions);
  }
  ...
  public actualizarAsistente(req: FormData): Observable<ActualizarInvitadoResponse> {
    ...
    return this.http.put<ActualizarInvitadoResponse>(`${backendUrl}api/asistencia/actualizar`, req, httpOptions);
  }
  ...
  public marcarAsistenciaActaSesionTrabajo(formData: FormData): Observable<FirmantesResponse> {
    ...
    return this.http.put<FirmantesResponse>(`${backendUrl}api/actas/actualizarfirmante`, formData, httpOptions);
  }
